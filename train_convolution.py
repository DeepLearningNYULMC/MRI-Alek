...
def main(_):
  ...
  x2 = pickle.load(open( "all_x_no_normalization_withLGG.p", "rb" ))
  print("x2 loaded.")
  y2 = pickle.load(open( "all_y_no_normalization_withLGG.p", "rb" ))
  print("y2 loaded.")
  validate_x2 = pickle.load(open( "all__validation_x_no_normalization_withLGG.p", "rb" ))
  print("validate_x2 loaded.")
  validate_y2 = pickle.load(open( "all__validation_y_no_normalization_withLGG.p", "rb" ))
  ...
  output_file= open("validation_loss_file_no_normalization.txt","w+")
  ...
  with tf.Session(config = config) as sess:
    ...
    for i in range(1000000):
      ...
      if i % 10000 == 0:
        ...
        name = 'my-model_(single gpu)testing_no_normalization_epoch_' + str(i)
    ...
    print(avg_loss)
    output_file.close()
    save_path = saver.save(sess, 'my-model_testing_no_normalization_final')
