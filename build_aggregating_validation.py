...
pickle.dump(test_x2, open( "T1_GD_testing_x_no_normalization_aggregated_.p", "wb" ), protocol=4)
pickle.dump(test_y2, open( "T1_GD_testing_y_no_normalization_aggregated.p", "wb" ), protocol=4)