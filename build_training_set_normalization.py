...
for root, dirs, filenames in os.walk("/data/ak4966/MRI/data/new_data/T1_training/train"):
...
validate_x1 = []
validate_y1 = []
for root, dirs, filenames in os.walk("/data/ak4966/MRI/data/new_data/T1_training/validation"):
# if num_of_pts >= 200: #only do 200 slices
#   break
	for f in filenames:
	  print(os.path.join(root, f))
...
#shuffling code
validate_x2 = numpy.asarray(validate_x2)
...
pickle.dump(x2, open( "all_x_l2normalization.p", "wb" ), protocol=4)
pickle.dump(y2, open( "all_y_l2normalization.p", "wb" ), protocol=4)
pickle.dump(validate_x2, open( "all__validation_x_l2normalization.p", "wb" ), protocol=4)
pickle.dump(validate_y2, open( "all__validation_y_l2normalization.p", "wb" ), protocol=4)
